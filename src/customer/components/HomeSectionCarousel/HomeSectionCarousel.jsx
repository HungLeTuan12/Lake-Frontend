    ...
    return (
        <div className="border">
            ...
            <div className="relative p-5">
                ...
                {activeIndex !== 0 && <Button onClick={slidePrevious} variant="contained" className="z-50 bg-white" sx={{position:"absolute", top:"8rem", left:"0rem", transform:"translateX(-50%) rotate(-90deg)", bgcolor:"white"}}>
